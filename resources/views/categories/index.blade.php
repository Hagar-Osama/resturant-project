                                      ...
                                      <td>
                                        <div class="d-flex my-xl-auto right-content">
                                          <div class="pr-1 mb-3 mb-xl-0">
                                            <a type="button" href="{{route('categories.show', ['category' =>$category->id])}}" class="btn btn-info  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Show"><i class="far fa-eye"></i></a>
                                          </div>
                                          <div class="pr-1 mb-3 mb-xl-0">
                                              <form method="{{route('categories.destroy', ['category' => $category->id])}}" action="POST">
                                                  @csrf
                                                  {{method_field('DELETE')}}
                                          ...
                                          <div class="pr-1 mb-3 mb-xl-0">
                                            <a type="button" href="{{route('categories.edit', ['category' => $category->id])}}" class="btn btn-warning btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
