              ...
              <div class="card">
                <div class="card-body">
                  <form method="POST" action="{{route('categories.update', ['category' => $category->id])}}">
                    ...
                    <div class="row row-xs formgroup-wrapper">
                      <div class="col-md-12 mg-t-10">
                          <div class="form-group">
                              ...
                              <input class="form-control" name="name" value="{{$category->name}}" placeholder="Enter category name" required type="text">
                          </div><!-- main-form-group -->
                      </div>
                      @error('name')
                    ...
                    @enderror
                      <div class="col-12">
                          <button class="btn btn-main-primary pd-x-20 mg-t-20" type="submit">Edit </button>
                      </div>
                    </div>
                  </form>
                </div>
