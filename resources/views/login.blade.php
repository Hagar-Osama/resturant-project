												...
												<div class="main-signup-header">
													...
													<form action="#" data-parsley-validate="">
														<div class="form-group">
															<label>Email</label> <input class="form-control" required placeholder="Enter your email" type="text">
														</div>
														<div class="form-group">
															<label>Password</label> <input class="form-control" required placeholder="Enter your password" type="password">
