	...
	<body class="main-body app sidebar-mini dark-theme">
		...
		<div class="page">
				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						<li class="slide">
						  ...
						  <ul class="slide-menu">
							<li><a class="slide-item" href="../chefs/index.html">Show All Chefs</a></li>
							<li><a class="slide-item" href="../chefs/create.html">Create New Chef</a></li>
						  </ul>
						</li>
						<li class="slide">
						  <a class="side-menu__item" data-toggle="slide" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">Categories</span><i class="angle fe fe-chevron-down"></i></a>
						  <ul class="slide-menu">
							<li><a class="slide-item" href="../categories/index.html">Show All Categories</a></li>
							<li><a class="slide-item" href="../categories/create.html">Create New Category</a></li>
						  </ul>
						</li>
						<li class="slide">
						  <a class="side-menu__item" data-toggle="slide" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">Menus</span><i class="angle fe fe-chevron-down"></i></a>
						  <ul class="slide-menu">
							<li><a class="slide-item" href="../menus/index.html">Show All Menus</a></li>
							<li><a class="slide-item" href="../menus/create.html">Create New Menu</a></li>
						  </ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">Galleries</span><i class="angle fe fe-chevron-down"></i></a>
							<ul class="slide-menu">
							  <li><a class="slide-item" href="../galleries/index.html">Show All Galleries</a></li>
							  <li><a class="slide-item" href="../galleries/create.html">Create New Gallery</a></li>
							</ul>
						</li>
					</ul>
				</div>
          ...
          <div class="breadcrumb-header justify-content-between">
              <div class="my-auto">
                <div class="d-flex">
                  <h4 class="content-title mb-0 my-auto">Galleries</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Show</span>
                </div>
              </div>
          </div>
          <!-- breadcrumb -->
                ...
                <div class="card-body">
                  ...
                  <div class="demo-gallery">
                    <ul id="lightgallery" class="list-unstyled row row-sm">
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/1.jpg" data-src="../../assets/img/photos/1.jpg" data-sub-html="<h4>Gallery Image 1</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/1.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/2.jpg" data-src="../../assets/img/photos/2.jpg" data-sub-html="<h4>Gallery Image 2</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/2.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/3.jpg" data-src="../../assets/img/photos/3.jpg" data-sub-html="<h4>Gallery Image 3</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/3.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/4.jpg" data-src="../../assets/img/photos/4.jpg" data-sub-html="<h4>Gallery Image 4</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/4.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/5.jpg" data-src="../../assets/img/photos/5.jpg" data-sub-html="<h4>Gallery Image 5</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/5.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/6.jpg" data-src="../../assets/img/photos/6.jpg" data-sub-html="<h4>Gallery Image 6</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/6.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/7.jpg" data-src="../../assets/img/photos/7.jpg" data-sub-html="<h4>Gallery Image 7</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/7.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/8.jpg" data-src="../../assets/img/photos/8.jpg" data-sub-html="<h4>Gallery Image 8</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/8.jpg" alt="Thumb-1">
                        </a>
                      </li>
                      <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/photos/9.jpg" data-src="../../assets/img/photos/9.jpg" data-sub-html="<h4>Gallery Image 9</h4>" >
                        <a href="">
                          <img class="img-responsive" src="../../assets/img/photos/9.jpg" alt="Thumb-1">
                        </a>
                      </li>
                    </ul>
                    <!-- /Gallery -->
