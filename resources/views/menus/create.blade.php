	...
	<body class="main-body app sidebar-mini dark-theme">
		...
		<div class="page">
          ...
          <div class="breadcrumb-header justify-content-between">
              <div class="my-auto">
                  <div class="d-flex">
                      <h4 class="content-title mb-0 my-auto">Menus</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Create</span>
                  </div>
              </div>
          </div>
          <!-- breadcrumb -->
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-body">
                  <form action="#" method="post" data-parsley-validate="" id="selectForm" name="selectForm">
                    <div class="row row-xs">
                      ...
                      <div class="col-md-12 mg-t-10">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="price" placeholder="Enter price" required type="text">
                        </div><!-- main-form-group -->
                      </div>
