	...
	<body class="main-body app sidebar-mini dark-theme">
		...
		<div class="page">
          ...
          <div class="breadcrumb-header justify-content-between">
              <div class="my-auto">
                <div class="d-flex">
                  <h4 class="content-title mb-0 my-auto">Menus</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Show</span>
                </div>
              </div>
          </div>
          <!-- breadcrumb -->
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Show All Menus</h4>
                        </div>
                    </div>
                <div class="card-body">
                      ...
                      <table id="example" class="table table-hover key-buttons text-md-nowrap">
                        ...
                        <tbody>
                          <tr>
                            <td>Rowe-Spinka</td>
                            <td>BREAKFAST</td>
                            <td>This time Alice waited till the Pigeon the opportunity of saying to herself, as she tucked it away under her arm, with its legs hanging down, but.</td>
                            <td>71</td>
                            <td>
                              <div class="d-flex my-xl-auto right-content">
                                ...
                                <div class="pr-1 mb-3 mb-xl-0">
                                  <a type="button" href="../menus/edit.html" class="btn btn-warning  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                                </div>
                              </div>
                            </td>
                          </tr>
