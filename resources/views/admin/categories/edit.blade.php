            ...
            <div class="row row-xs formgroup-wrapper">
              <div class="col-md-12 mg-t-10">
                  <div class="form-group">
                      ...
                      <input class="form-control @error('name') is-invalid fparsley-error parsley-error @enderror" name="name" value="{{$category->name}}" placeholder="Enter category name" required type="text" value="">
                      @error('name')
