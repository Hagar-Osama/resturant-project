                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex my-xl-auto right-content">
                                        ...
                                        <div class="pr-1 mb-3 mb-xl-0">
                                            <a type="button" href="{{route('categories.edit', [$category->id])}}" class="btn btn-warning btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
