...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">About US</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Create /</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('about.store')}}" data-parsley-validate="" enctype="multipart/form-data">
                    @csrf
                    <div class="row row-xs">
                        <div class="col-md-12 mg-t-10">
                            <div class="form-group">
                                <label class="form-label">Body <span class="tx-danger">*</span></label>
                                <textarea class="form-control" placeholder="Enter body" required name="body" rows="5"></textarea>
                            </div>
                        </div>
                        @error('body')
