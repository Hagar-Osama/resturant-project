        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="{{route('welcome')}}" class="page-scroll">Home</a></li>
                    <li><a href="{{route('menu')}}" class="page-scroll">Menu</a></li>
                    <li><a href="{{route('gallery')}}" class="page-scroll">Gallery</a></li>
                    <li><a href="{{route('chefs_page')}}" class="page-scroll">Chefs</a></li>
                    <li><a href="{{route('contact_us')}}" class="page-scroll">Contact</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
