                                    ...
                                    <td>
                                        <div class="d-flex my-xl-auto right-content">
                                            <div class="pr-1 mb-3 mb-xl-0">
                                                <a type="button" href="{{route('chefs.show',['chef' => $chef->id])}}" class="btn btn-info btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Show"><i class="far fa-eye" style="color: #fff"></i></a>
                                            </div>
                                            <div class="pr-1 mb-3 mb-xl-0">
                                                <form action="{{route('chefs.destroy', ['chef' => $chef->id])}}" method="POST">
                                                    @csrf
                                                    {{method_field('DELETE')}}
                                            ...
                                            <div class="pr-1 mb-3 mb-xl-0">
                                                <a type="button" href="{{route('chefs.edit', ['chef' => $chef->id])}}" class="btn btn-warning  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
