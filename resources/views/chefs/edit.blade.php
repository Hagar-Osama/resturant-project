...
<div class="container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Chefs</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Edit /</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row row-xs">
                            <div class="col-md-6 mg-t-10">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="name" value="{{$chef->name}}" placeholder="Enter firstname" required type="text">
                                </div><!-- main-form-group -->
                            </div>
                            @error('name')
                            ...
                            <div class="col-md-12 mg-t-10">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Enter description" required name="description" rows="5">{{$chef->description}}</textarea>
                                </div>
                            </div>
                            @error('description')
                            <div class="alert alert-danger">
                            ...
                            @if(! empty($chef->image))
                            <div class="form-group">
                                <img src="{{asset('images/chefs').'/'.$chef->image}}" height="300px" width="300px">
                            </div>
                            @endif
                            <div class="col-sm-12 col-md-4 mg-t-20">
                                ...
                                <input type="file" class="dropify" name="image" value="{{$chef->image}}" data-width="280" data-height="420" />
                            </div>
                            @error('image')
                            <div class="alert alert-danger">
                                <span class="alert-danger">{{$message}}</span>
